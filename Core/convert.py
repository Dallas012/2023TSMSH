...
def requests_call(input_file_name):
    ...
    ############## 수정 ##########################
    file_path = settings.MEDIA_ROOT + '\\PDF\\' + input_file_name# request 받은 파일 path 수정
    ...
    ############## 수정 ##########################
    result_file_path = settings.MEDIA_ROOT + '\\JSON\\' + file_name + '.json' # nanonets 결과물 저장되어 있는 폴더 경로
    ##############################################
    ...
    ############## 수정 ##########################
    insert_file_path = settings.MEDIA_ROOT+'\\Result\\' + file_name +".json" # 가공된 결과물 저장하기 위한 파일 경로
    ##############################################
